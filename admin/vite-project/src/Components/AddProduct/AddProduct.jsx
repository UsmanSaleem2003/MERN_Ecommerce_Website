...
export default function AddProduct() {
    ...
    const changeHandler = (e) => {
        setproductDetials({ ...productDetails, [e.target.name]: e.target.value });
    }
        ...
        <div className='addproduct'>
            ...
            <div className="addproduct-itemfield">
                <label htmlFor="file-input">
                    <img src={image ? URL.createObjectURL(image) : upload_area} alt="upload_area" className="addproduct-thumbnail-image" />
                </label>
