...
app.post("/addproduct", async (req, res) => {
    ...
    //logic for id increment automatically
    ...
    //creating an object of json format for frontend use
    res.json({
        success: true,
...
app.get('/allproducts', async (req, res) => {
    try {
        let products = await Product.find({}).select('id name image category new_price old_price');
...
app.post("/signup", async (req, res) => {
    ...
    //secret_ecom is salt for one level encryption
